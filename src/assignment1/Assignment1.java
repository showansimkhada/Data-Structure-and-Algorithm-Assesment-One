...
public class Assignment1 {
	...
	{
		// Declaring 20 integers in the array
		...
		try
		{
			// Declaring the scanner for file
			Scanner sc = new Scanner (f);
			for(int i = 0; i < myIntArray.length; i++)
			{
				// Importing the data from files in the array
	...
	public static int minimumNumber(int[] myIntArray)
	{
		...
		{
			// Assuming that minimum value is greater than the number in the array
